...
impl Label {
    ...
    pub fn take_value(&mut self) -> ::protobuf::Chars {
        ::std::mem::replace(&mut self.value, ::protobuf::Chars::new())
    }
}
...
impl ReadHints {
    ...
    pub fn clear_func(&mut self) {
        ::protobuf::Clear::clear(&mut self.func);
    }

    // Param is passed by value, moved
    pub fn set_func(&mut self, v: ::protobuf::Chars) {
        self.func = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_func(&mut self) -> &mut ::protobuf::Chars {
        &mut self.func
    }

    // Take field
    pub fn take_func(&mut self) -> ::protobuf::Chars {
        ::std::mem::replace(&mut self.func, ::protobuf::Chars::new())
    }
    ...
    pub fn get_grouping(&self) -> &[::protobuf::Chars] {
        &self.grouping
    }
    ...
    // Param is passed by value, moved
    pub fn set_grouping(&mut self, v: ::std::vec::Vec<::protobuf::Chars>) {
        self.grouping = v;
    }

    // Mutable pointer to the field.
    pub fn mut_grouping(&mut self) -> &mut ::std::vec::Vec<::protobuf::Chars> {
        &mut self.grouping
    }

    // Take field
    pub fn take_grouping(&mut self) -> ::std::vec::Vec<::protobuf::Chars> {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_carllerche_string_into(wire_type, is, &mut self.func)?;
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                5 => {
                    ::protobuf::rt::read_repeated_carllerche_string_into(wire_type, is, &mut self.grouping)?;
                },
                6 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ometheus.LabelR\x06labels\x12,\n\x07samples\x18\x02\x20\x03(\x0b2\x12.pr\
    ometheus.SampleR\x07samples\"1\n\x05Label\x12\x12\n\x04name\x18\x01\x20\
    ...
    \x06chunks\x18\x02\x20\x03(\x0b2\x11.prometheus.ChunkR\x06chunksB\x08Z\
    \x06prompbb\x06proto3\
";
